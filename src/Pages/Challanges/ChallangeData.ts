...
export const NEW_CHALLANGES_DATA = [
  {
    ...
    level: 1,
    description:
      "This HTML and CSS-only landing page will be an excellent test of  your UI and responsive skillsThere's also some fun to be had creating the curved section borders!",
  },
  {
    image: image2,
    price: "Free",
